...
class DepthEstimate():
    ...
    def __init__(self, depth_pred, num_bins, max_depth, resize_to=None):
    ...
    def to(self, device):
        ...
        return DepthEstimate(depth_pred, self.num_bins, self.max_depth, resize_to=self.resize_to)
    ...
    def mle(self):
        ...
        mle_depth = torchvision.transforms.functional.resize(mle_depth, self.resize_to)
        return mle_depth
    ...
    def get_trustworthy_depth(self, include_mask=None, confidence=0.9, max_conf_int_width_prop=0.30):
        ...
        est_depth = self.mle()
        if self.resize_to:
            accept_mask = torchvision.transforms.functional.resize(
                accept_mask,  

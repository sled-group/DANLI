...
from sledmap.mapper.utils.base_cls import Task
from sledmap.mapper.env.alfred.wrapping.annotations import AlfredAnnotations, TrajData
...
def task_traj_lengths():
    ...
    for task_type in TASK_TYPES:
        ...
        from sledmap.mapper.env.alfred.alfred_action import INTERACT_ACTION_TYPES

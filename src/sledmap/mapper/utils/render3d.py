...
def initialize_visualizer_view_angle(vis: o3d.visualization.Visualizer, angle=0.0):
...
def update_and_render_new_voxel_grid(vis: o3d.visualization.Visualizer, new_voxel_grid: VoxelGrid):
    geometry, centroid = voxelgrid_to_geometry(new_voxel_grid)
...
def render_geometries(geometry, animate=False, num_frames=18, centroid=None, camera_angle='topdown'):
    vis = o3d.visualization.Visualizer()

    if camera_angle == 'topdown':
        T_extrinsic, intrinsics = get_topdown_extrinsics()  # (centroid)
    elif camera_angle == 'side1':
        T_extrinsic, intrinsics = get_side_extrnsics_1()
    elif camera_angle == 'side2':
        T_extrinsic, intrinsics = get_side_extrnsics_2()
    elif camera_angle == 'default':
        T_extrinsic, intrinsics = None, {"height": 1080, "width": 1920}

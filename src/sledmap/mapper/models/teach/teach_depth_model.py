...
from sledmap.mapper.utils.base_cls import LearnableModel
...
from sledmap.mapper.models.alfred.hlsm.unets.unet_5 import UNet5

from sledmap.mapper.ops.depth_estimate import DepthEstimate


class TeachDepthModel(LearnableModel):
    ...
    def __init__(self, hparams=None):
        ...
        hparams = Hyperparams({
            # This is config for perception model, which will be loaded by
            # StateTracker inside AlfredEnv
            "perception_model": {
                "train_for": None,
        ...
        with torch.no_grad():
            if self.distr_depth:
                ...
                depth_pred = DepthEstimate(
                    depth_pred, self.depth_bins, self.max_depth_m, resize_to=FRAME_SIZE
                )
    ...
    def get_name(self) -> str:
        return "teach_segmentation_and_depth_model"
...
from sledmap.mapper import model_registry
model_registry.register_model("teach_depth_model", TeachDepthModel)

...
GoToPose proposed implementation:
Pass in x,y,z (in voxel index) and target yaw and pitch
then use GoTo+RotateToYaw+TiltToPitch to navigate
'''
...
class GoToPoseSkill(Skill):

    def __init__(self, target_x_voxel_index, target_y_voxel_index, target_z_voxel_index, target_pitch, target_yaw):
        ...
        self.target_x_voxel_index = target_x_voxel_index
        self.target_y_voxel_index = target_y_voxel_index
        self.target_z_voxel_index = target_z_voxel_index
    ...
    def _reset(self):
        self.target_x_voxel_index = None
        self.target_y_voxel_index = None
        self.target_z_voxel_index = None
    ...
    def _construct_cost_function(self, state_repr: AlfredSpatialStateRepr):
        ...
        x, y, z = self.target_x_voxel_index, self.target_y_voxel_index, self.target_z_voxel_index  # this x,y,z must be voxel index

...
from sledmap.mapper.models.alfred.projection.projection_ops import scatter_add_and_pool
from sledmap.mapper.models.alfred.projection.constants import ROUNDING_OFFSET

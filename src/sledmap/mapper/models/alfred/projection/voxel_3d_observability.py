...
from sledmap.mapper.models.alfred.projection.projection_ops import project_3d_camera_points_to_2d_pixels, project_3d_points
...
class Voxel3DObservability(nn.Module):
    ...
    def forward(self,
        ...
        voxel_observability_mask = voxel_observability_mask.long() # (b,1,61,61,10)

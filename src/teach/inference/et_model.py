...
import torch
import sys
# sys.path.append('src/teach/modeling/ET')
...
class ETModel(TeachModel):
    ...
    def start_new_edh_instance_cheating(self, edh_instance, edh_history_images, edh_name=None, env=None):
        return self.start_new_edh_instance(edh_instance, edh_history_images, edh_name)
